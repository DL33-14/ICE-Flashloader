/**
  ...
  * @file           : usbd_conf.c
  * @version        : v1.0_Cube
  * @brief          : Source for usbd_conf.c file.
  ******************************************************************************
*/
/* Includes ------------------------------------------------------------------*/
#include "stm32f4xx.h"
...
{
  utils_printLog("usb conf");
  /* Init USB Ip. */
  if (pdev->id == DEVICE_FS) {
    utils_printLog("usb DEVICE_FS");
  ...
  utils_printLog("pre pcd hal");
  if (HAL_PCD_Init(&hpcd_USB_OTG_FS) != HAL_OK)
  {
    utils_printLog("pcd init fail");
    Error_Handler( );
  }
