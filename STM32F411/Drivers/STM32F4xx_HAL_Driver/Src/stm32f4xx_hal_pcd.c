...
HAL_StatusTypeDef HAL_PCD_Init(PCD_HandleTypeDef *hpcd)
{
  ...
  if (hpcd == NULL)
  {
    utils_printLog("HAL_PCD_Init null");
    return HAL_ERROR;
  }
  ...
  {
    utils_printLog("HAL_PCD_Init reset");
  ...
  {
    utils_printLog("HAL_PCD_Init core init");
  ...
  {
    utils_printLog("HAL_PCD_Init set current mode");
    hpcd->State = HAL_PCD_STATE_ERROR;
    return HAL_ERROR;
  }
  ...
  {
    utils_printLog("HAL_PCD_Init dev init");
    hpcd->State = HAL_PCD_STATE_ERROR;
    return HAL_ERROR;
  }
